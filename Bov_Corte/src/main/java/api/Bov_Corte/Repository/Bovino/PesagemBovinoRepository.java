...
@Repository 
public interface PesagemBovinoRepository extends CrudRepository<PesagemBovino, Integer> {

    @Query("Select pb from PesagemBovino pb " +
            "inner join BovinoFazenda bf on bf.pkBovinoFazenda = pb.fkAnimalFazenda " +
            "where bf.fkAnimal = ?1 and bf.fkFazenda = ?2 order by pb.dtPesagem desc")
    List<PesagemBovino> getAllPesagemByBovinoAndFazeda(int fkAnimal, int fkFazenda);
...
//====================================================================================================================//
    ...
    @Query(nativeQuery = true, value = "select " +
            ...
            " inner join pesagem_bovino pb on pb.fk_animal_fazenda = bf.pk_bovino_fazenda " +
